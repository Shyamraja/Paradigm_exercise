...
/* package yes-0.1.0.0 */
#ifndef VERSION_yes
#define VERSION_yes "0.1.0.0"
#endif /* VERSION_yes */
#ifndef MIN_VERSION_yes
#define MIN_VERSION_yes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_yes */
...
#define CURRENT_COMPONENT_ID "yes-0.1.0.0-inplace-yes"
